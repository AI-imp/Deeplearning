...
class SegDataset(Dataset):
    def __init__(self, root=r'E:\python\project\AI_course-master\awesome\VOCdevkit\VOC2012', file='train.txt', w=144, h=144, transform=None):
...
def train():
    ...
    width = 128
    height = 128
    train_data = SegDataset(root=r'E:\python\project\AI_course-master\awesome\VOCdevkit\VOC2012', file='train.txt', w=width, h=height, transform=transforms.ToTensor())
    val_data = SegDataset(root=r'E:\python\project\AI_course-master\awesome\VOCdevkit\VOC2012', file='val.txt', w=width, h=height, transform=transforms.ToTensor())
